...
<template>
    <div class="p-8">
        ...
        <div class="flex items-center w-full relative h-full">
            <img width="140" :src="telos.albumCover">
            ...
            <div class="w-full ml-5">
                ...
                <div class="text-gray-300 text-[13px] flex">
                    ...
                    <div class="ml-2 flex">
                        ...
                        <span class="-ml-0.5">{{ telos.releaseYear }}</span>
                    </div>
                    <div class="ml-2 flex">
                        <div class="circle mt-2 mr-2"/>
                        <span class="-ml-0.5">{{ telos.tracks.length }} songs</span>
                    </div>
                </div>
        ...
        <ul class="w-full" v-for="track, index in telos.tracks" :key="track">
            <SongRow :artist="telos" :track="track" :index="++index" />
        </ul>
    </div>
</template>
